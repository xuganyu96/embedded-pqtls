...
#define WOLFSSL_VIS_FOR_TESTS /* enable so BuildTls13Message does not raise    \
                                 deprecastion warnings */
...
#define WOLFSSL_HAVE_ISSUER_NAMES /* Store pointers to issuer name components  \
                                     and their lengths and encodings */
#define WOLFSSL_SUBJ_DIR_ATTR /* Enable support for SubjectDirectoryAttributes \
                                 extension */
#define WOLFSSL_SUBJ_INFO_ACC /* Enable support for SubjectInfoAccess          \
                                 extension */
#define WOLFSSL_CERT_NAME_ALL /* Adds more certificate name capability at the  \
                                 cost of taking up more memory. Adds initials, \
                                 givenname, dnQualifer for example */
#define WOLFSSL_FPKI      /* Enable support for FPKI (Federal PKI) extensions */
#define WOLFSSL_AKID_NAME /* Enable support for full AuthorityKeyIdentifier    \
                             extension. Only supports copying full AKID from   \
