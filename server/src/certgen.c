 ...
 */
static enum CertType root_key_type = FALCON_LEVEL5_TYPE;
static enum Ctc_SigType root_sig_type = CTC_FALCON_LEVEL5;
static enum CertType int_key_type = FALCON_LEVEL5_TYPE;
static enum Ctc_SigType int_sig_type = CTC_FALCON_LEVEL5;
