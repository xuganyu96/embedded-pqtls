 ...
 */
static enum CertType root_key_type = ECC_TYPE;
static enum Ctc_SigType root_sig_type = CTC_SHA256wECDSA;
static enum CertType int_key_type = ECC_TYPE;
static enum Ctc_SigType int_sig_type = CTC_SHA256wECDSA;
