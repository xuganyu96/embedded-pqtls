...
static enum CertType leaf_key_type = FALCON_LEVEL1_TYPE;
static enum Ctc_SigType leaf_sig_type = CTC_FALCON_LEVEL1;
static enum CertType client_key_type = FALCON_LEVEL1_TYPE;
static enum Ctc_SigType client_sig_type = CTC_FALCON_LEVEL1;
